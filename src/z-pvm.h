...
extern void pvm_compute_view_mat4(float res[4][4], float eye[3],
				  float target[3], float up[3]);
extern void pvm_compute_proj_mat4(float[4][4], float a, float th, float zn,
				  float zf);
